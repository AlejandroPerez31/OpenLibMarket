...
public class HistorialComprasController {
    ...
    public HistorialComprasController(Usuario usuario, ObtenerHistorialOrdenesUseCase obtenerHistorialOrdenesUseCase, GenerarFacturaPdfUseCase generarFacturaPdfUseCase) {
